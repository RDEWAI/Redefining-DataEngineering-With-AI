...
|---|---|---|---|
| PySpark `pyspark[pipelines]` | 4.0.0 | https://spark.apache.org/docs/4.0.0/api/python/index.html | **Pinned to 4.0.0 (not 4.1.1)** — spark-expectations 2.10.0 declares `pyspark[connect]<=4.0.0,>=3.0.0`; PySpark 4.1.x is incompatible. |
...
| Apache Airflow Spark provider | 6.0.1 | https://airflow.apache.org/docs/apache-airflow-providers-apache-spark/ | Targets Airflow 3.x; pairs with the in-airflow PySpark 4.0.0 install. |
