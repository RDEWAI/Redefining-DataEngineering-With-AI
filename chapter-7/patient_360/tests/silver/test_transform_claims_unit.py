...
class TestCleanse:
    ...
    def test_stm_transformations(self, spark):
        ...
        assert r["appointment_id"] == "enc-001"  # TRIM(APPOINTMENTID) — STM row 156
        assert r["provider_id"] == "prv-001"  # TRIM(PROVIDERID)
        assert r["primary_payer_id"] == "ins-001"  # TRIM(PRIMARYPATIENTINSURANCEID) — STM row 154
