# Claude Code Instructions — chapter-5

## Project
**patient_360** — Patient 360 medallion pipeline (Bronze → Silver → Gold)
...
- `patient_360/` — main Python project
  - `src/patient_360/` — importable package (bronze / silver / gold / utils)
