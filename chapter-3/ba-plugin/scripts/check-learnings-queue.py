...
ROLE = "drd"
OUTPUT_PATH_MARKER = "/outputs/drd/"
...
def main():
    ...
    # Locate chapter root: plugin is at chapter-N/{plugin}/scripts/
    chapter_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
