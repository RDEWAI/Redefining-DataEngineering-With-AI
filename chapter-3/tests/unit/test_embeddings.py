...
class TestBookEmbeddings:
    ...
    def test_create_book_text_for_embedding(self) -> None:
        ...
        from src.rag.embeddings import create_book_text_for_embedding
