...
class Sale:
    ...
    def is_bulk_purchase(self) -> bool:
        ...
        Returns:
            True if quantity is greater than 1
        """
    ...
    def is_discounted(self) -> bool:
        ...
        Returns:
            True if discount is greater than 0
        """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Returns:
            Dictionary with sale fields, with enum values as strings
            and date as ISO format string.
        """
        return {
    ...
    def from_row(cls, row: tuple) -> "Sale":
        ...
        Args:
            row: Tuple with values in order: (sale_id, book_id, sale_date,
                quantity, unit_price, total_amount, discount, payment_method,
                customer_id, customer_segment, region, channel)
    ...
    def from_dict(cls, data: dict[str, Any]) -> "Sale":
        ...
        Args:
            data: Dictionary with sale fields. Enum fields can be
