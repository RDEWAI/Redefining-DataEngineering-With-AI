...
logger = logging.getLogger("chapter2.library.repository")
...
def get_repository(db_path: str | None = None, read_only: bool = True) -> BookRepository:
    ...
    Args:
        db_path: Path to DuckDB database file. Defaults to
            chapter-2/data/duckdb/chapter2.db relative to project root.
    ...
    """
    if db_path is None:
        # Default path relative to chapter-2 directory
        default_path = (
