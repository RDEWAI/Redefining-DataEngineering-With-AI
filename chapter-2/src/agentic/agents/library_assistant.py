...
# Load .env from chapter-2 directory (override=True to replace existing env vars)
# Path: library_assistant.py -> agents/ -> agentic/ -> src/ -> chapter-2/
...
from src.agentic.library import tools as library_tools  # noqa: E402
from src.agentic.llm.base import (  # noqa: E402
    LLMProvider,
    LLMResponse,
    Message,
    ToolCall,
...
# Initialize logger
logger = get_logger("chapter2.agents.library_assistant")
