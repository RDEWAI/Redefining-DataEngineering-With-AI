...
# Path: library_assistant_enhanced.py -> agents/ -> agentic/ -> src/ -> chapter-2/
env_path = Path(__file__).parent.parent.parent.parent / ".env"
load_dotenv(env_path, override=True)

# Add parent directory to path for imports
# Add both src/ and chapter-2/ to support both import styles
sys.path.insert(0, str(Path(__file__).parent.parent))  # src/
sys.path.insert(0, str(Path(__file__).parent.parent.parent))  # chapter-2/
...
from src.agentic.code_execution.sandbox import CodeSandbox  # noqa: E402
from src.agentic.code_execution.tool_api import ToolAPIGenerator  # noqa: E402
from src.agentic.library.repository import BookRepository  # noqa: E402
from src.agentic.library.tools import close_repository, reopen_repository  # noqa: E402
from src.agentic.llm.base import LLMProvider, Message  # noqa: E402
from src.agentic.logging_config import get_logger  # noqa: E402
from src.agentic.tools.dummy_tools import get_total_tool_count  # noqa: E402

# Initialize logger
logger = get_logger("chapter2.agents.library_assistant_enhanced")
...
class EnhancedLibraryAssistant:
    ...
    def __init__(
        ...
        # Setup database path
        self._db_path = db_path or os.getenv("DB_PATH", "data/duckdb/chapter2.db")
