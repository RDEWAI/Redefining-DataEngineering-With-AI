...
```bash
cat architect-plugin/memory/learnings-queue.jsonl
```
...
1. Read the target skill file:
   `architect-plugin/skills/{skill-name}/SKILL.md`
...
After all learnings are processed, update `architect-plugin/memory/learnings-queue.jsonl`:
