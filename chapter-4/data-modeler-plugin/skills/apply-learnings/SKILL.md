...
```bash
cat data-modeler-plugin/memory/learnings-queue.jsonl
```
...
1. Read the target skill file:
   `data-modeler-plugin/skills/{skill-name}/SKILL.md`
...
After all learnings are processed, update `data-modeler-plugin/memory/learnings-queue.jsonl`:
