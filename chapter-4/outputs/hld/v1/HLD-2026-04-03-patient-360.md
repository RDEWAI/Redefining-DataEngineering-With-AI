...
| Catalog / metastore | Unity Catalog OSS | Approved in technology catalog; provides table discovery across Bronze/Silver/Gold layers within single `spark_catalog` namespace |
...
- Unity Catalog OSS requires Spark catalog name = `spark_catalog`; arbitrary catalog names require additional configuration not supported in current infra
...
| 1.0 | 2026-05-20 | Architect Agent | Status changed to Approved |
