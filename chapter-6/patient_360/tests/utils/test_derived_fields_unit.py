...
class TestEncounterDuration:
    def test_simple_duration(self) -> None:
        assert encounter_duration_minutes("2026-01-01T10:00:00", "2026-01-01T10:45:00") == 45

    def test_zero_duration(self) -> None:
        assert encounter_duration_minutes("2026-01-01T10:00:00", "2026-01-01T10:00:00") == 0
