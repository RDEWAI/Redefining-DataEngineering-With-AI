...
def test_missing_se_runner_logs_diagnostic_and_reraises(
    ...
    error_records = [
        ...
        and "se_runner not available" in r.getMessage()
    ]
    assert error_records, (
        "Expected ERROR-level log line containing "
        "'se_runner not available' before re-raise"
    )
