...
- SE-runner inline-DQ execution fix (LLD §2.3 v1.17 SE rule-matching & isolation contract — closes the §13 Decision 16 silent-DQ no-op)
...
| STORY-02-010 | Fix SE runner so inline DQ actually executes | build | 5 | 5 | STORY-01-010, STORY-02-001, STORY-02-005 |

| STORY-02-007 | Performance: dynamic partition overwrite pruning + shuffle.partitions + observations 8-partition tuning | performance-optimization | 3 | 5 | STORY-02-001, STORY-02-003 |
